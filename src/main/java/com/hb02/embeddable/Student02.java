...
public class Student02 {
	...
	@Embedded
	private Address address; // in the table, we are gonna see the address column under the student entity because by using embedded annotation, we actually called the embeddable entity
