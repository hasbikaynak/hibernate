...
//		Configuration con=new  Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(Student02.class); // we added this into cfg.xml file
		//if we have more class we will implement them into xml file
